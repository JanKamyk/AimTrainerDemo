...
public class TF_Mini_Control : MonoBehaviour
{
    ...
    float lowerBound_x = -1.5f;
    float upperBound_x = 1.5f;
    float lowerBound_y = 1f;
    float upperBound_y = 3.5f;
    float set_z = 13.5f;
    ...
    void Start()
    {
        ...
        loadTileFrenzy.onClick.AddListener(LoadTileFrenzy);
